                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        /* Query SQL */
                                        $sql = "SELECT receita.Id_Receita, receita.Nome_paciente, consultorios.Nome_Consultorio, receita.Data_atual, receita.CID FROM receita INNER JOIN consultorios on receita.Endereco = consultorios.IDConsultorio";
                                        ...
                                        while ($cont = mysqli_fetch_array($resultado)) {
                                            echo "
                                                        <tr>
                                                        <td>" . $cont['Id_Receita'] . "</td>
                                                        <td>" . $cont['Data_atual'] . "</td>
                                                        <td>" . $cont['Nome_paciente'] . "</td>
                                                        <td>" . $cont['Nome_Consultorio'] . "</td>
                                                        <td>" . $cont['CID'] . "</td>
                                                        <td><a href='geradorReceitaLista.php?Id_Receita=".$cont['Id_Receita']."'><button type='button' class='btn btn-outline-success btn-sm' target='_blank'>Imprimir</button></a></td>
                                                        </tr>";
                                            $inc++;
                                        }
